...
(function(){
	...
	var mainState = {
		...
		create : function(){
			...
			var style = { font: "24px Arial", fill: "#111111", align: "left" };
			this.scoreText = this.game.add.text(10,4,"Score : "+this.score,style);
			this.livesText = this.game.add.text(10,32,"Lives : "+this.lives,style);
	...
	var menuState = {
		preload : function(){
			...
			this.game.load.audio('titlemusic', 'assets/Hekatonus.mp3', 0.2, true);
